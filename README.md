...
At the moment I'm working on the DMT online editor that is based on the [JSON Editor](https://github.com/josdejong/jsoneditor) and I kept, momentarily, the major instructions of the editor itself below. More updates coming soon.
...
- Documentation:
  - [API](https://github.com/monicams/dmt/tree/master/docs/api.md)
  - [Usage](https://github.com/monicams/dmt/tree/master/docs/usage.md)
  - [Shortcut keys](https://github.com/monicams/dmt/tree/master/docs/shortcut_keys.md)
- [Examples](https://github.com/monicams/dmt/tree/master/examples)
- [Source](https://github.com/monicams/dmt)
- [History](https://github.com/monicams/dmt/blob/master/HISTORY.md)
